	...
	render() {
		return <>
			<header>
				...
				<p>We are using SDL and OpenGL, two of the most cross platform compatible C libraries available. Also the
					style of C will be mostly ANSI C, although later I will show some C++ as well - kinda I tend to use more of a
